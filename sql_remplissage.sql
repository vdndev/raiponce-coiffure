...
INSERT INTO avis(prenom, message) VALUES
("Marielle", "Mes cheuveux ont ete coupes comme jamais auparavant, c'est un moment que je n'oublierai pas."),
("Michel", "Je n'etait pas trop a l'aise en entrant, mais le proprietaire est tres sympathique et m'a de suite detendu.");
